...
import { OMNIDEF } from './vlocityAccountSearchEnglish_def.js';
import tmpl from './vlocityAccountSearchEnglish.html';
import tmpl_nds from './vlocityAccountSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vlocityAccountSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
