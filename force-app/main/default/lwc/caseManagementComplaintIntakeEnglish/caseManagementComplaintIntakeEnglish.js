...
import { OMNIDEF } from './caseManagementComplaintIntakeEnglish_def.js';
import tmpl from './caseManagementComplaintIntakeEnglish.html';
import tmpl_nds from './caseManagementComplaintIntakeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseManagementComplaintIntakeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
