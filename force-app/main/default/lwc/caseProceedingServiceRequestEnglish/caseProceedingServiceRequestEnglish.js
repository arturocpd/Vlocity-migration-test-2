...
import { OMNIDEF } from './caseProceedingServiceRequestEnglish_def.js';
import tmpl from './caseProceedingServiceRequestEnglish.html';
import tmpl_nds from './caseProceedingServiceRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseProceedingServiceRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
