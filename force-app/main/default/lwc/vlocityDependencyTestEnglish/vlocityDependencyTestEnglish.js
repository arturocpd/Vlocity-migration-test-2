...
import { OMNIDEF } from './vlocityDependencyTestEnglish_def.js';
import tmpl from './vlocityDependencyTestEnglish.html';
import tmpl_nds from './vlocityDependencyTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vlocityDependencyTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
